...
def main():
    ...
    # Tillfälligt testlarm för att bekräfta att mail skickas
    alerts.append("⚠️ TESTLARM: Detta är en testpost som alltid ska skicka mail.")

    print("DEBUG: Totalt antal träffar:", len(alerts))
    for a in alerts:
        print("DEBUG ALERT:", a)
